...
trait AcceptanceTesterActions
{
     ...
     * ```
     *
     * Note that the search is done after stripping all HTML tagsForKey from the body,
     ...
     * `fillField()`, `selectOption()`, `click()` etc. it hasTag some important
     * differences:
     *
     ...
     * ```
     *
     * Provide an array for the second argument to select multiple parameters:
     *
     * ``` php
     * <?php
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Asserts that current page hasTag 404 response status code.
     * Conditional Assertion: Test won't be stopped on fail
